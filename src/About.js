...
function About() {
  return (
    <div id="about-me" className="flex flex-col h-screen bg-gradient-to-br from-slate-950 to-slate-800 px-4 py-8">
      {/* Section Title */}
      <section className="text-center mb-8">
        <h1 className="text-4xl text-white font-mono font-extrabold">ABOUT ME</h1>
      </section>
      ...
      <div className="flex flex-col md:flex-row justify-center items-start md:space-x-8 space-y-8 md:space-y-0 px-8">
        ...
        <div className="flex-1 bg-slate-900 hover:bg-slate-950 hover:rounded-2xl transition-all shadow-lg rounded-md p-4 max-w-xs mx-auto md:mx-0">
          <h2 className="text-xl text-white text-center font-mono font-extrabold mb-4">Technologies</h2>
        ...
        {/* Hobbies Card */}
        <div className="flex-1 bg-slate-900 hover:bg-slate-950 hover:rounded-2xl transition-all shadow-lg rounded-md p-4 max-w-xs mx-auto md:mx-0">
          <h2 className="text-xl text-center text-white font-mono font-extrabold mb-4">Hobbies</h2>
      ...
      <div className="flex flex-col md:flex-row justify-center items-start md:space-x-8 space-y-8 md:space-y-0 px-8 my-8">
        {/* Experience Card */}
        <div className="flex-1 bg-slate-900 hover:bg-slate-950 hover:rounded-2xl transition-all shadow-lg rounded-md p-4 max-w-xs mx-auto md:mx-0">
          <h2 className="text-xl text-white text-center font-mono font-extrabold mb-4">Experience</h2>
          {/* Add your experience content here */}
        </div>

        {/* Certifications Card */}
        <div className="flex-1 bg-slate-900 hover:bg-slate-950 hover:rounded-2xl transition-all shadow-lg rounded-md p-4 max-w-xs mx-auto md:mx-0">
          <h2 className="text-xl text-center text-white font-mono font-extrabold mb-4">Certifications</h2>
      ...
      <section className="flex flex-col items-center mt-8 px-4">
        ...
        <h2 className="text-2xl text-white font-mono font-extrabold mb-4">BIO</h2>
