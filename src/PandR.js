    ...
    return (
        <div className="flex flex-row justify-around">
            ...
            <div className="bg-slate-950 flex-col rounded-xl mx-2 shadow-lg hover:bg-slate-900 hover:rounded-3xl transition-all my-4 h-[80vh] w-[70%] flex justify-center">
                ...
                {/*Image here*/}
                <h1 className="text-2xl mt-4 pl-8 text-white font-mono font-extrabold">
...
function Proj () {
    return (
    <div id="proj" className="bg-gradient-to-tr from-slate-950 to-slate-800 ">
        <div className="flex flex-col px-4 py-8">
            <section className="text-center mb-8">
                <h1 className="text-4xl text-white font-mono font-extrabold">PROJECTS & RESEARCH</h1>
            </section>
