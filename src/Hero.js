    ...
    <div className="flex flex-col items-center justify-center h-screen 
      ...
      <div className="bg-slate-950 shadow-2xl w-11/12 md:w-[70%] lg:w-[60%] xl:w-[50%] 
        ...
        <section className="text-center">
          ...
          <h1
            className="text-3xl md:text-5xl lg:text-6xl font-extrabold font-mono bg-gradient-to-r 
      ...
      <section className="text-center mt-6">
        <ul className="flex flex-row list-none space-x-4">
          <li
            className="bg-slate-950 shadow-md rounded-3xl hover:bg-orange-600 hover:rounded-xl 
